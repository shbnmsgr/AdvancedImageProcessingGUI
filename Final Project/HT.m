...
% Last Modified by GUIDE v2.5 17-Dec-2020 12:11:24
...
% varargin   command line arguments to HT (see VARARGIN)

% Choose default command line output for HT
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes HT wait for user response (see UIRESUME)
...
a = str2num(a);
[a1,a2,a3,a4] = haart2(double(image),a);
g = ihaart2(a1,a2,a3,a4,0);
